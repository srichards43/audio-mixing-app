...
public class AudioFileTest {
    ...
    public void testAudioFile_ValidData() {
        AudioFile file = new AudioFile("My Song", "My Artist", "My Album", 5000, "path/to/song.mp3", 123456789L);
    ...
    public void testAudioFile_NullData() {
        AudioFile file = new AudioFile(null, null, null, 1000, "test/path", 0);
    ...
    public void testAudioFile_FormattedDuration() {
        AudioFile file = new AudioFile("Title", "Artist", "Album", 61000, "path", 0);
